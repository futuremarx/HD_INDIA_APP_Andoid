...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "يجب شراؤها في مجموعات من ${number}";

  static String m24(itemCount) => "${itemCount} عنصر";

  static String m25(price) => "إجمالي الخيارات: ${price}";

  static String m26(amount) => "ادفع ${amount}";

  static String m27(total) => "الكمية: ${total}";

  static String m28(percent) => "بيع ${percent} ٪";

  static String m29(second) => "${second} ثواني ماضية";

  static String m30(totalCartQuantity) =>
      "سلة التسوق, تحتوي ${totalCartQuantity} عنصر";

  static String m31(numberOfUnitsSold) => "مباع: ${numberOfUnitsSold}";

  static String m32(fieldName) => "الحقل ${fieldName} مطلوب";

  static String m33(total) => "${total} من المنتجات";
  ...
  static String m35(date) => "صالح حتى ${date}";

  static String m36(message) => "تحذير: ${message}";

  static String m37(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة ، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m38(length) => "تم العثور على${length} منتجاً";

  static String m39(week) => "الأسبوع ${week}";

  static String m40(name) => "مرحبًا ${name}";

  static String m41(year) => " قبل${year} سنة";

  static String m42(total) => "لقد قمت بتعيين الطلب رقم${total}";
