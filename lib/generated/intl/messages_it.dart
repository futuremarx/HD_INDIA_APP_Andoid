...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "deve essere acquistato in gruppi di ${number}";

  static String m24(itemCount) => "${itemCount} prodotti";

  static String m25(price) => "Opzioni totali: ${price}";

  static String m26(amount) => "Paga ${amount}";

  static String m27(total) => "Qtà: ${total}";

  static String m28(percent) => "${percent}% di sconto";

  static String m29(second) => "${second} secondi fa";
  ...
  static String m32(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m33(total) => "${total} Prodotti";
  ...
  static String m35(date) => "Valido fino alle ${date}";

  static String m36(message) => "Attenzione: ${message}";
  ...
  static String m38(length) => "Abbiamo trovato \$length prodotti";

  static String m39(week) => "Settimana ${week}";

  static String m40(name) => "Benvenuto ${name}";

  static String m41(year) => "${year} anni fa";

  static String m42(total) => "Hai assegnato all\'ordine #${total}";
